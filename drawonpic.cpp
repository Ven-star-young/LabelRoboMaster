...
void DrawOnPic::load_svg()
{
    switch(label_mode){
        case Armor:
            ...
            big_svg_ploygen.append({857.002, 469.874});
            big_svg_ploygen.append({857.002, 0.});
            small_svg_ploygen.clear();
            small_svg_ploygen.append({0., 0.});
            small_svg_ploygen.append({0., 461.330});
            small_svg_ploygen.append({498.057, 461.330});
            small_svg_ploygen.append({498.057, 0.});
            break;
        case Wind:
