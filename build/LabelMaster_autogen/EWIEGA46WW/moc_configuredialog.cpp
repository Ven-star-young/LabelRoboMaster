...
QT_MOC_LITERAL(1, 16, 21), // "set_configures_signal"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 2), // "PD"
QT_MOC_LITERAL(4, 42, 2), // "VR"
QT_MOC_LITERAL(5, 45, 23) // "on_OKPushButton_clicked"

    },
    "Configuredialog\0set_configures_signal\0"
    "\0PD\0VR\0on_OKPushButton_clicked"
};
...
void Configuredialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->set_configures_signal((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Configuredialog::*)(float , float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Configuredialog::set_configures_signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Configuredialog::set_configures_signal(float _t1, float _t2)
{
